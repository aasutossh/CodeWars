def dirReduc(plan):
    ...
    a man was given directions to go from one point to another. The directions
     ...
     opposite, "WEST" and "EAST" too. Going to one direction and coming back
     the opposite direction is a needless effort. Since this is the wild west,
     with dreadfull weather and not much water, it's important to save
    ...
    going north and coming back right away. What a waste of time! Better to do
    nothing.
